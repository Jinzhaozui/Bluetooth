...
//        }
    ...
    @Override
    public byte[] convertSendLowBluetooth(HXFramePara paraModel, ICommucation commDevice) throws IOException {
        commParaModel = paraModel;
        byte[] sndByt;
        frameCnt++;
        paraModel.frameCnt = frameCnt;
    ...
    @Override
    public byte[] convertReceiverLowBluetooth(HXFramePara paraModel, ICommucation commDevice) throws IOException {
