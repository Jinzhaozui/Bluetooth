...
import com.hexing.bluetooth.BluetoothConstant;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_DATA_AVAILABLE_NS = "com.example.bluetooth.le.ACTION_DATA_AVAILABLE_NS";
    public final static String ACTION_DATA_AVAILABLE_ID = "com.example.bluetooth.le.ACTION_DATA_AVAILABLE_ID";
...
//			Toast.makeText(getApplicationContext(), "通知回调", Toast.LENGTH_SHORT).show();
    ...
    public class LocalBinder extends Binder {
        public BluetoothLeService getService() {
            mInstance = BluetoothLeService.this;
            return mInstance;
        }
    }

    static BluetoothLeService mInstance;
    ...
    public boolean connect(final String address) {
        ...
        Log.e(TAG, "services 蓝牙连接-" + address);
