package com.hexing.bluetooth.protocol.bll;

import com.hexing.bluetooth.protocol.model.TranXADRAssist;
...
public class dlmsService {
    ...
    public final static String DATA_TYPE_BOOL = "BOOLEAN";
    ...
    public static String TranXADRCode(byte[] XADRcodeStr) {
        ...
        switch (XADRcodeStr[0] & 0xff) {
            case 2:
                ...
                RtnValue = TmUInt32;
                RtnStr.append(Double.toString(RtnValue));
                break;
            case 3:// boolean
                RtnStr.append(Integer.toString((XADRcodeStr[1] & 0xff)));
                break;
            case 5:// integer32
            ...
            case 9:
                if ((XADRcodeStr[1] & 0xff) >= 0x80) {
                    ...
                    for (int i = 0; i < (XADRcodeStr[1] & 0xff); i++) {
                        RtnStr.append(String.format("%02x",
                ...
                break;
            case 10:
                RtnStr.append(Byte2String(XADRcodeStr, 2, XADRcodeStr.length - 2)
                        .replace(" ", ""));
                break;
            case 16:
            case 18:// unsigned16
                int u16 = (XADRcodeStr[1] & 0xff) * 0x100 + (XADRcodeStr[2] & 0xff);
                RtnStr.append(Integer.toString(u16));
                break;
            case 17:
            ...
            case 22:
                ...
                RtnStr.append(String.format("%02d", Tmp));
                break;
            ...
            case 23:
                ...
                RtnStr.append(Float.toString(getFloat(tmpbytes)));
                if (RtnStr.toString().indexOf('.') > 0) {
                    RtnStr.append("00");
                    RtnStr.append(RtnStr.toString().substring(0, RtnStr.toString().indexOf('.') + 3));
                }
                break;
        }
    ...
    public static String GetXADRCode(String EncodeStr, DataType TypeStr) {
        ...
        switch (TypeStr) {
            ...
            case Int32:// 1234->06 80 00 04 d2
                RtnStr = "05" + String.format("%08x", (Integer.parseInt(EncodeStr)));
                break;
            //case unsigned32:// "00120F1108"->"0600120F1108"
            case U32:
                // RtnStr = "06" + EncodeStr.PadLeft(10, '0');
                RtnStr = "06" + String.format("%08x", (Double.parseDouble(EncodeStr)));
                break;
