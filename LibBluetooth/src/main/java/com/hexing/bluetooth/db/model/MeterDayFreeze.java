...
@DatabaseTable(tableName = DBConfig.TABLE_METER_DAY_FREEZE)
public class MeterDayFreeze {
    //id |server_id |device_id| create_time|positive_active|reverse_active|freeze_time|update_time|retry_num
